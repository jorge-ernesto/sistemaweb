...
if($boton=="Consultar") {
	...
	echo("	location.href='cmpr_oc_poralmacen.php?v_fecha_desde=".$v_fecha_desde."&v_fecha_hasta=".$v_fecha_hasta."&v_almacen=".$v_almacen."&v_proveedor=".$v_proveedor."&v_articulo=".$v_articulo."' " );
	echo('</script>');
	}
...
<div align="center">
  CONSULTA COMPRAS POR ALMACEN DESDE: <?php echo $v_fecha_desde; ?> HASTA: <?php echo $v_fecha_hasta; ?> 
  <?php
...
if(pg_numrows($v_xsql)>0)	{	$v_descalma=pg_result($v_xsql,0,0);	}
?>
...
<table border="1">
	...
	<tr>
		...
		<td><font size="-4" face="Arial, Helvetica, sans-serif">Proveedor: </font></td>
		<td><font size="-4" face="Arial, Helvetica, sans-serif"> 
			<input type="text" name="v_proveedor"  value='<?php echo $v_proveedor ; ?>' readonly="true">
			<img src="../images/help.gif" width="16" height="15" onClick="javascript:mostrarAyuda('/sistemaweb/maestros/ayuda/lista_ayuda.php','f_name.v_proveedor','f_name.v_descprov','proveedores')"> 
			</font></td>
		<td colspan="2"><font size="-4" face="Arial, Helvetica, sans-serif"> 
			<input type="text" name="v_descprov" size="50" readonly="true">
			</font></td>
	...
	<tr>
		...
		<td><font size="-4" face="Arial, Helvetica, sans-serif"> 
			<input type="text" name="v_articulo"  value='<?php echo $v_articulo ; ?>' readonly="true">
			<img src="../images/help.gif" width="16" height="15" onClick="javascript:mostrarAyuda('/sistemaweb/maestros/ayuda/lista_ayuda.php','f_name.v_articulo','f_name.v_descart','articulos')"> 
			</font></td>
		<td colspan="2"><font size="-4" face="Arial, Helvetica, sans-serif"> 
...
<p>
  <iframe name="consulta" src="cmpr_oc_poralmacen_1.php?v_fecha_desde=<?php echo $v_fecha_desde; ?>&v_fecha_hasta=<?php echo $v_fecha_hasta; ?>&v_almacen=<?php echo $v_almacen?>&v_proveedor=<?php echo $v_proveedor?>&v_articulo=<?php echo $v_articulo?>" width="1000" height="320" style="overflow:hidden" scrolling="auto" frameborder="0"></iframe>
</p>
</form>
</body>
</html>
