<html>
<head>
<title>Sistema de Combustibles - Inventario Minimo y Maximo</title>
...
<script language="JavaScript" src="js/stkminmax.js"></script>
</head>
<body>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.STKMINMAX" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
