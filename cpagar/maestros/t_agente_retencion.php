...
class AgenteRetencionTemplate extends Template {
 
  function titulo(){
    $titulo = '<div align="center"><h2>Agentes de Retenci&oacute;n</h2></div><hr>';
    return $titulo;
  }
  ...
  function listado($registros){
    ...
    $titulo_grid = "AGENTES DE RETENCI&Oacute;N";
  ...
  function formBuscar($paginacion){
   //echo "ENTRO BUSCAR\n";
    ...
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_RETENCION'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_RETENCION'));
  ...
  function formAgenteRetencion($datos)
  {
    //print_r($registrosXml);
    $siNo = array('N'=>'No',
                  'S'=>'Si');
    
    $form = new form2('AGENTE DE RETENCI&Oacute;N', 'form_agen_ret', FORM_METHOD_POST, 'control.php', 'multipart/form-data', 'control');
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_RETENCION'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_RETENCION'));
