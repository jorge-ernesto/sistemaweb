<html>
<head>
<title>Combustibles - Interfaces Electronicas</title>
...
<script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/maestros/js/sismaestrotrab.js"></script>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.INTELEC" frameborder="1" width="10" height="10"></iframe>
</body>
</html>