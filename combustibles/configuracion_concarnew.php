<html>
 <head>
  <title>Sistema de Configuracion - Configuracion Contable Concar</title>
   ...
   <script language="JavaScript" src="js/cuentas_bancarias.js"></script>
 </head>
...
<div id="content">
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.CONFIGURARCONCARNEW" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
