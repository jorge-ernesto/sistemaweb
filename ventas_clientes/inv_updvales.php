...
//echo "NATURALEZA ".$naturform."size ".strlen($naturform);
...
if(trim($naturform)=="1" or trim($naturform)=="2") {
	...
	$updalmac=$updalmacd;
	$updnatu="3";
	$addalma1=" and tab_car_02='2' ";  $addalma2="";
	$flagcito="B";
...
//  echo $updalmac."-".$updalmaco."-".$updalmacd;
//	if(!isset($f_valart) and !isset($f_almo) and !isset($f_almd) and !isset($f_prov) and !isset($f_tipodoc)) {
	...
	//echo "MIERDA updalmac $updnatu ----->".$newcostounit;
...
<form name='formular' action="inv_updvales.php?fm=<?php echo $fm;?>&nromov=<?php echo $nromov;?>" method="post">
...
<input type="hidden" name="nromov" value="<?php echo $nromov;?>">
  ...
  <table border="1">
    <tr>
      <th width="211">SUCURSAL</th>
      <td width="8">:</td>
      <td width="218"><?php echo $almacen;?></td>
    </tr>
    <tr>
...
<?php if($entform=="P") { ?><input type="hidden" name="entform" value="<?php echo $entform;?>">
    <tr>
      <th>PROVEEDOR</th>
      <td>:</td>
