<html>
 <head>
  <title>Sistema de Ventas - Configuracion de Tanques</title>
   ...
   <script language="JavaScript" src="js/tanques.js"></script>
 </head>
 ...
 <body>
  ...
  <?php include "../menu_princ.php"; ?>
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.TANQUES" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
