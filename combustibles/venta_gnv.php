...
<html>
	<head>
		...
		<title>Sistema de Combustibles - Liquidacion de Venta GNV</title>
...
<body>
	...
	<div id="footer">&nbsp;</div>
	<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.VARILLAS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
