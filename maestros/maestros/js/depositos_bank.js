function PaginarRegistros(rxp, valor) {   	
	urlPagina = 'control.php?rqst=REPORTES.DEPOSITOSBANK&rxp='+rxp+'&pagina='+valor;
	document.getElementById('control').src = urlPagina;	
}

function PaginarRegistrosFecha(rxp, valor, fecha, fecha2) {   	
	urlPagina = 'control.php?rqst=REPORTES.DEPOSITOSBANK&action=Buscar&rxp='+rxp+'&pagina='+valor+'&fecha='+fecha+'&fecha2='+fecha2;
	document.getElementById('control').src = urlPagina;	
}
...
function regresar() {
	url = 'control.php?rqst=REPORTES.DEPOSITOSBANK';
