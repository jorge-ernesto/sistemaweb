...
//include('lib/paginador_new.php');
  //echo " entrando a TargpromocionTemplate \n"; 
...
//METODO QUE RETORNA UN MENSAJE DE ERROR
  function errorResultado($errormsg){
    ...
    $columnas = array('Nº CUENTA','NOMBRE CUENTA','Nº TARJETA','NOMBRE TARJETA','PLACA','PUNTOS CUENTA', 'PUNTOS TARJETA');
...
for($i=0;$i<count($columnas);$i++)
	...
	$listado .= '<tr >';
	$listado .='<td class="'.$color.'"><a href="control.php?rqst=MOVIMIENTOS.TARGPROMOCION&task=TARGPROMOCION&action=ModificarCuenta&cuentaid='.$reg["id_cuenta"].'" target="control" alt= "Ver Datos de Cuenta">'.$reg["nu_cuenta_numero"].'&nbsp;</a></td>';
	...
	$listado .='<td class="'.$color.'">'.$reg["nu_tarjeta_puntos"].'&nbsp;</td>';
      ...
      if($reg["id_tarjeta"]!=''){
      $listado .= '<td class="'.$color.'"> <A href="control.php?rqst=MOVIMIENTOS.TARGPROMOCION&task=TARGPROMOCION&action=ModificarTarjeta&tarjetaid='.$reg["id_tarjeta"].'&cuentaid='.$reg["id_cuenta"].'&numcuenta='.$reg["nu_cuenta_numero"].'&numtarjeta='. $reg["nu_tarjeta_numero"].'&desctarjeta='.$reg["ch_tarjeta_descripcion"].'&placatarjeta='.$reg["ch_tarjeta_placa"].'&titulartarjetaSINO='.$reg['ch_tarjeta_titular'].'&fechacre='.$reg['dt_tarjeta_creacion'].'&fechaven='.$reg['dt_tarjeta_vencimiento'].'" target="control"><img alt="Editar Tarjeta" src="/sistemaweb/icons/kedit32x32.png" align="middle" border="0"/></A>&nbsp;</td>';
	}else{
	$listado .= '<td class="'.$color.'"><img src="/sistemaweb/icons/kedit32x32disabled.png" border="0" alt="Sin Tarjetas"></td>';
	
	}
if($reg["nu_tarjeta_numero"]==''){
		$listado .= '<td class="'.$color.'" ><a href="javascript:confirmarLink(\'¿Desea eliminar la cuenta Nº '.
		$reg['nu_cuenta_numero'].'?\',\'control.php?rqst=MOVIMIENTOS.TARGPROMOCION&task=TARGPROMOCION&action=EliminarCuenta&cuentaid='.
		$reg["id_cuenta"].'\',\'control\')"><img alt="Eliminar Cuenta" src="/sistemaweb/icons/delete22x22.png" align="middle" 		
					border="0"/></a></td>';	
		}else{
			$listado .= '<td class="'.$color.'" ><a><img alt="No se puede Eliminar Cuenta" src="/sistemaweb/icons/delete22x22disabled.png" 
 ...
 function formBuscar($paginacion){
   echo "ENTRO BUSCAR\n";
    ...
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MOVIMIENTOS.TARGPROMOCION'));
...
$form->addElement(FORM_GROUP_MAIN, new f2element_submit('action','Nueva Cuenta',espacios(3)));
   ...
   echo ' entro a formTargpromocion';
    ...
    echo "id de cuenta es: ".@$cuenta["id_cuenta"]."\n";
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<table border="0" cellspacing="2" cellpadding="2"> <tr>
	<td colspan="2" align="center" class="form_cabecera">'));
...
// $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('Codigo Sucursal </td><td>:&nbsp;&nbsp;'. $_SESSION['almacen']));
 $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentanumero','NÚMERO CUENTA *  </td><td>: ', trim(@$cuenta["nu_cuenta_numero"]),'', 25, 15,'',array('onkeypress="return soloNumeros(event)"')));
...
$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentadni','DNI  </td><td>: ',trim(@$cuenta["ch_cuenta_dni"]),'', 25, 
    15,'',array()));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
	
    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentaruc','RUC  </td><td>: ', 
    trim(@$cuenta["ch_cuenta_ruc"]),'', 25, 15,'',array()));	
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
   
 $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentadireccion','DIRECCIÓN  </td><td>: ', trim(@$cuenta["ch_cuenta_direccion"]),'', 50, 50));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));

    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentatelefono1','TELÉFONO   </td><td>: ', trim(@$cuenta["ch_cuenta_telefono1"]),'', 25, 20));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));

    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('cuentatelefono2','OTRO TELÉFONO   </td><td>: ', trim(@$cuenta["ch_cuenta_telefono2"]),'', 25, 20));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
	...
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</select >'));
		...
		//$form->addElement(FORM_GROUP_MAIN, new f2element_combo('tarjetatitular','TIPO DE CUENTA   </td><td>: ','', $arrTiposCuenta));
	...
	// INICIO DE LOS CAMPOS DEL FORMULARIO SOLO COMO LECTURA
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<table border="0" 
	cellspacing="2" cellpadding="2"> <tr><td colspan="2" align="center" class="form_cabecera">'));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('DATOS DE CUENTA  </td></tr><tr><td>'));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr>'));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td width="20%" class="form_texto"> '));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('NÚMERO CUENTA  </td><td width="80%" class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["nu_cuenta_numero"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> NOMBRES  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_nombres"]).'</span></td></tr>'));    
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> APELLIDOS  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_apellidos"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> DNI  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_dni"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> RUC  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_ruc"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> DIRECCIÓN  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_direccion"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> TELÉFONO  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_telefono1"]).'</span></td></tr>'));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> OTRO TELÉFONO  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_telefono2"]).'</span></td></tr>'));
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> E-MAIL  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["ch_cuenta_email"]).'</span></td></tr>'));
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> PUNTOS  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["nu_cuenta_puntos"]).'</span></td></tr>'));
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td class="form_texto"> VENCIMIENTO  </td><td class="form_texto">:&nbsp;<span class="form_valor_texto">'
	.trim(@$cuenta["dt_fecha_vencimiento"]).'</span></td></tr>'));
    	
	// LINEA O REGLA TAG = <HR>	
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr><td colspan="2"><HR></td></tr>'));
	...
	// INICIO DE LA TABLA QUE CONTENDRA AL FORMULARIO TARJETAS
    $form->addElement(FORM_GROUP_MAIN,new f2element_freeTags('<table border="0">'));
	// INICIO DE LA CABECERA DEL FORMULARIO TARJETAS
	$form->addElement(FORM_GROUP_MAIN, 
	new f2element_freeTags('<tr>
							<td>NUMERO</td>
							<td>DESCRIPCION</td>
							<td>PLACA</td>
							<td>¿TITULAR?</td>
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('tarjetanumero','', '','', 15, 15,'',
	array('onkeypress="return soloNumeros(event)"'))); 
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td><td valign="top">'));	
    $form->addElement(FORM_GROUP_MAIN, new f2element_text ('tarjetafechaven','','','', 13, 15,'',
	array('readonly'))); 
    $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td valign="top">
	<a href="javascript:show_calendar('."'form_cuentapromocion.tarjetafechaven'".');">
	<img src="/sistemaweb/images/showcalendar.gif"   border=0></a>&nbsp;&nbsp;'));                  
   	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<div id="overDiv" 	
    ...
    $form->addElement(FORM_GROUP_MAIN, new f2element_button('button','Adicionar Tarjeta', 
	espacios(2),array('onclick'=>'validar_registro_tarjeta();')));	
	$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr>'));
	
	echo "tamanio tarjetas ".count($arrTarjetas);
	if(count($arrTarjetas)>0){
		...
		$color = ($contador%2==0?"grid_detalle_par":"grid_detalle_impar");
			...
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<tr>'));
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.$reg['nu_tarjeta_numero'].'</td>'));
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.$reg['ch_tarjeta_descripcion'].'</td>'));		
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.$reg['ch_tarjeta_placa'].'</td>'));
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.((trim($reg['ch_tarjeta_titular'])=='1')?'SI':'NO').'</td>'));
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.$reg['dt_tarjeta_creacion'].'</td>'));		
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td class="'.$color.'">'
			.$reg['dt_tarjeta_vencimiento'].'</td>'));
	
	
			$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td>
			<a href="javascript:confirmarLink(\'¿Desea eliminar la tarjeta Nº '
			.$reg['nu_tarjeta_numero'].
			'?\',\'control.php?rqst=MOVIMIENTOS.TARGPROMOCION&task=TARGPROMOCION'
			.'&action=EliminarTarjeta&cuentaid='.$reg['id_cuenta']
			.'&tarjetaid='.$reg['id_tarjeta']
			.'\', \'control\')">
   ...
   /* $form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('<td bgcolor="#FFFFCD" valign="top" width="25">'));
	...
	function formTarjetapromocion($cuenta,$tarjeta){
				
		$SiNo = array('1' => 'SI',
			      '2' => 'NO');
			
		$form = new form2('', 'form_tarjetapromocion', FORM_METHOD_POST, 'control.php', '', 'control','onSubmit="return validar_registro_tarjeta();"');
		...
		$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('NÚMERO CUENTA </td><td class="form_texto">:&nbsp;&nbsp;<span class="form_valor_texto">'. @$cuenta["nu_cuenta_numero"]));
		$form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('idcuenta', @$cuenta["id_cuenta"]));
		...
		$form->addElement(FORM_GROUP_MAIN, new f2element_text ('tarjetanumero','NÚMERO TARJETA </td><td class="form_texto">: ', trim(@$tarjeta["nu_tarjeta_numero"]),'', 25, 15,'',array('onkeypress="return soloNumeros(event)"')));
		$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
		
		
		$form->addElement(FORM_GROUP_MAIN, new f2element_text ('tarjetadescripcion','DESCRIPCIÓN  </td><td class="form_texto">: ',trim(@$tarjeta["ch_tarjeta_descripcion"]),'', 50, 50,'',array()));
		$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
		...
		$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('FECHA CREACIÓN </td><td class="form_texto">:&nbsp;&nbsp;<span class="form_valor_texto">'. @$tarjeta["dt_tarjeta_creacion"]));
		...
		$form->addElement(FORM_GROUP_MAIN, new f2element_combo('tarjetatitular','¿ TITULAR ? </td><td class="form_texto">: ', trim(@$tarjeta["ch_tarjeta_titular"]), $SiNo));
		$form->addElement(FORM_GROUP_MAIN, new f2element_freeTags('</td></tr><tr><td class="form_texto">'));
