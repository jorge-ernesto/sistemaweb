...
function validar_registro_cuenta(){
	...
	txtApellido 	= document.getElementsByName('cuentaapellidos')[0];
	txtFN 		= document.getElementsByName('cuentafechanacimiento')[0];
	txtDni		= document.getElementsByName('cuentadni')[0];
	txtTelefono	= document.getElementsByName('cuentatelefono1')[0];
	txtDireccion	= document.getElementsByName('cuentadireccion')[0];
	...
	if (txtNumero.value==''){
		...
		alert('¡Ingrese Apellidos de titular de cuenta!');
		return false;
	}
	else if(txtFN.value==''){
		alert('¡Ingrese Fecha de Nacimiento de titular de cuenta!');
		return false;
	}
	else if(txtDni.value==''){
		alert('¡Ingrese DNI de titular de cuenta!');
		return false;
	}
	else if(txtTelefono.value==''){
		alert('¡Ingrese Telefono de titular de cuenta!');
		return false;
	}
	else if(txtDireccion.value==''){
		alert('¡Ingrese Direccion de titular de cuenta!');
		return false;
	}
	else return true;
