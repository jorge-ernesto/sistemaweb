...
function Guardar(){
	...
	nu_costo_unitario	= document.getElementById('nu_costo_unitario').value;
	tot_dolares			= document.getElementById('tot_dolares').value;
