...
class ReportesController extends Controller {
	...
	function Run() {
		...
		switch ($this->request) {
			...
			case "DOCUMENTOS" :
				include "reportes/c_documentos.php";
				$Controlador = new DocumentosController("DOCUMENTOS");
				break;
		  	case "AJUSTEDOCUMENTOS":
                		include "reportes/c_ajuste_documentos.php";
                		$Controlador = new AjusteDocumentosController($this->task);
                		break;
