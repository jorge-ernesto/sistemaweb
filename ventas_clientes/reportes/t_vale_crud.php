<?php
class ValeCRUDTemplate extends Template {
	function Inicio($estaciones, $fecha) { ?>
        <div id="template-Vale_Credito">
        	<div class="container">
		        <h1 align="center">Registro de Vales de Crédito</h1>
		        <br>
	    	</div>
			...
			<div class="columns">
				...
				<div class="column">
		        	...
		        	<input type="text" class="input" id="txt-fe_inicial" name="fe_inicial" autocomplete="off" value="<?php echo (empty($_REQUEST['fe_inicial']) ? $fecha : $_REQUEST['fe_inicial']); ?>" />
		        </div>

			  	<div class="column">
		        	<label class="label">F. Final</label>
		        	<input type="text" class="input" id="txt-fe_final" name="fe_final" autocomplete="off" value="<?php echo (empty($_REQUEST['fe_final']) ? $fecha : $_REQUEST['fe_final']); ?>" />
		        </div>

	  			<div class="column">
		            <label class="label">Estado</label>
	    			<span class="select">
					    <select id="cbo-Nu_Estado">
				...
				<div class="column">
		        	...
		        	<input type="text" class="input" id="txt-nu_ticket" name="nu_ticket" autocomplete="on" placeholder="Ingresar numero ticket" />
		       	</div>
		    </div>
