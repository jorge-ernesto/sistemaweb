		...
		$form->addElement(FORM_GROUP_HIDDEN, new form_element_hidden("rqst", "MAESTROS.SERIEDOCUMENTO"));
			...
			if($_REQUEST['action'] == 'Modificar'){
				...
				if($_REQUEST['action'] == 'Agregar'){
					...
					$form->addElement(FORM_GROUP_MAIN, new form_element_text('', 'serie', "", '</td></tr><tr><td colspan="2" style="text-align:right;">', '', 3, 3, false,'onkeypress="return validar(event,2)"'));
					$form->addElement(FORM_GROUP_MAIN, new form_element_anytext("Numero: </td><td style='text-align:left;'>"));
					$form->addElement(FORM_GROUP_MAIN, new form_element_text('', 'numero', "" , '</td></tr><tr><td colspan="2" style="text-align:right;">', '', 10, 10, false,'onkeypress="return validar(event,2)"'));
					...
					$form->addElement(FORM_GROUP_MAIN, new form_element_anytext('</td><td style="text-align:left;">'));
					$form->addElement(FORM_GROUP_MAIN, new form_element_text("", "serie", $fila['serie'], "", "",3,3,($_REQUEST['action']=='Modificar'?array('readonly'):array())));
					...
					$form->addElement(FORM_GROUP_MAIN, new form_element_anytext('</td><td style="text-align:left;">'));
					$form->addElement(FORM_GROUP_MAIN, new form_element_text('', 'numero', trim($fila['numero']), "", "",10,10,false,'onkeypress="return validar(event,2)"'));			
