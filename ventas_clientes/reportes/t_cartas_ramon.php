...
class CartasTemplate extends Template {
  ...
  function pdfImprimir($datos_array)
  {
    ...
    //$pdf->SetXY(1,1);
    $pdf->Output("/sistemaweb/ventas_clientes/reportes/pdf/reporte_cartas_ramon.pdf", "F");
    return '<iframe src="/sistemaweb/ventas_clientes/reportes/pdf/reporte_cartas_ramon.pdf" width="900" height="300"></iframe>';
  }
}
