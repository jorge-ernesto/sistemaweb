...
<html>
	<head>
		...
		<title>Sistema de Combustibles - Estadistica de Ventas</title>
	...
	<?php include "../menu_princ.php"; ?>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.ESTADISTICA" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
