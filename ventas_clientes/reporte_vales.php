...
<html>
                ...
                $('#btnseleccionar').click(function(){
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            sNumeroDocumentoIdentidad: $.trim($('#txt-Nu_Documento_Identidad').val()),
                            sNombreCliente: $.trim($('#txt-No_Razsocial').val()),
                            tipo_cal:$('#tipo_cal').val(),
                            iTipoCliente:$('#cbo-tipo-cliente').val(),
                            iDecimales:$('#cbo-decimales').val(),
                            ordenar_por:$('#cbo-ordenar-por').val(),
                        },
                        success:function(xm){
                            $('#cargardor').css({'display':'none'});
                            // console.log(xm);
    ...
    <body>
        ...
        <div id="cargardor" style="position: absolute;display: none"><img src="liquidacion_vales/cg.gif" /></div>
            ...
            include('reporte_vales/t_reporte_vales.php');
            include('reporte_vales/m_reporte_vales.php');
            include('reporte_vales/c_reporte_vales.php');
            $objtem = new ReporteValesTemplate();
            echo ReporteValesTemplate::FormularioPrincipal();
            ?>
        <script type="text/javascript">
            //   $( "#fecha_inicio" ).datepicker( "option", "dateFormat","yy-mm-dd");
