<html>
<head>
<title>Sistema de Combustibles - Contometros Mecanicos</title>
...
<script language="JavaScript" src="js/cont_mecanicos.js"></script>
</head>
<body>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.CONTMECANICOS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
