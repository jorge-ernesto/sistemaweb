<html>
 <head>
  <title>Sistema de Ventas - Configuracion de Productos</title>
...
<div id="content">
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.CONFIGPRODUCTO" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
