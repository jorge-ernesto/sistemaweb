...
$objtem = new VencimientoLotesTemplate();
$objcomn = new VencimientoLotesController();
...
$data 	= VencimientoLotesModel::completarpedido($almacen, $producto, $tipopedido);
...
echo "{'dato1':'$data1','dato2':'$data2','dato3':'$data3','dato4':'$data4','dato5':'$data5','dato6':'$data6','dato7':'$data7'}";
