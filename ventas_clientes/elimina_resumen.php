...
<title>Sistema de Ventas - Facturaciones</title>
  ...
  <script language="JavaScript" src="js/sisresumen.js"></script>
</head>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=FACTURACION.RESUMEN&task=RESUMEN" frameborder="1" width="10" height="10"></iframe>
</body>
</html>