...
<html>
	<head>
		...
		<title>Sistema de Ventas - Ventas por Proveedor</title>
	...
	<body>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.VENTASXPROVEEDOR" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>