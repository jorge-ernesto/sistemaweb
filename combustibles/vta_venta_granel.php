<html>
<head>
<title>Interface Opensoft - Pedidos de Venta a Granel</title>
...
<script language="JavaScript" src="js/ventagranel.js"></script>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.VENTAGRANEL" frameborder="1" width="5" height="5"></iframe>
</body>
</html>
