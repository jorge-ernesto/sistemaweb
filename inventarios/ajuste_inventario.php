<html>
<head>
<title>Sistema de Inventario - Ajuste de Inventario Fisico</title>
...
<script language="JavaScript1.2" src="/sistemaweb/inventarios/js/ajuste_inventario.js"></script>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.AJUSTEINVENTARIO&task=REGISTROS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
