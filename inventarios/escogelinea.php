...
<?php //if($boton=="Seleccionar") { ?>
<script>
function escojlinea(){
    opener.document.formular.linea.value = document.formular1.escoglinea.value;
...
<input type="Button" name="boton" value="Seleccionar" onclick="escojlinea()">
<?php
  }
//}
?>
