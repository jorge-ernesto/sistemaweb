...
class ConsultaCanjesModel extends Model {
	...
	function llamadaRemota($procedimiento, $parametros) {
    	...
    	$url = "http://" . $ip . "/sistemaweb/puntos/index.php?action=consultacanjes&proc=" . urlencode($procedimiento);
	...
	function tmListado($almacen,$numerotarjeta,$descitem,$fechaini,$fechafin,$pp, $pagina) {
		$params = array(
    		...
    		return ConsultaCanjesModel::llamadaRemota("tmListado", $params);
  	}
