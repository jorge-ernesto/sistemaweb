...
$rsd       = pg_exec("SELECT tab_descripcion FROM int_tabla_general WHERE tab_tabla='$varx' AND tab_elemento='000000';");
$D         = pg_fetch_array($rsd,0);
...
if($boton == "adicionar") {
	...
	if($ilimitai == 0) {
		...
		<script LANGUAGE="JavaScript">
			alert(" El codigo <?php echo $newelem; ?>  ya existe !!!")
		</script>
		<?php
	}
}
...
<br>
<?php
$sql = "SELECT * FROM int_tabla_general WHERE tab_tabla='02';";
