...
<title>Sistema de Ventas - Maestro de clientes</title>
  ...
  <script language="JavaScript" src="js/sisfacturasespeciales.js"></script>
</head>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=FACTURACION.ESPECIALES&task=ESPECIALES" frameborder="1" width="10" height="10"></iframe>
</body>
</html>