<html>
 <head>
  <title>Sistema de Ventas - Cuentas Bancarias</title>
   ...
   <script language="JavaScript" src="js/man_rubro.js"></script>
 </head>
...
<div id="content">
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.MAN_CASHOPE" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
