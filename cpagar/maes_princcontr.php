...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.SUNAT_PRINCCONTR&task=SUNAT_PRINCCONTR" frameborder="1" width="5" height="5"></iframe>
</body>
</html>