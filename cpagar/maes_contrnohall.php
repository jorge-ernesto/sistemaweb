<html>
<head>
<title>Sistema de Ventas - Maestro de Agentes Sunat</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.SUNAT_CONTRNOHALL&task=SUNAT_CONTRNOHALL" frameborder="1" width="5" height="5"></iframe>
</body>
</html>