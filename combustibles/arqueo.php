...
<html>
	<head>
		...
		<title>Sistema de Combustibles - Registro de Ventas</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.ARQUEO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
