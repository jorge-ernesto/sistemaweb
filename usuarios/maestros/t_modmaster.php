...
class ModMasterTemplate extends Template {
    function titulo() {
	return '<h2 style="color:#336699;" align="center">Maestro de M&oacute;dulos y Opciones</td>';
    }
	...
	$result .= '<th class="grid_cabecera" width="60">Nombre</th>';
	$result .= '<th class="grid_cabecera" width="120">Descripci&oacute;n</th>';
	$result .= '</tr>';
	...
	$form->addElement(FORM_GROUP_MAIN, new form_element_text("M&oacute;dulo:", "ch_modulo", '', '<br>', '', 12, 10));
	$form->addElement(FORM_GROUP_MAIN, new form_element_text("Descripci&oacute;n:", "ch_descripcion", '', '<br>', '', 22, 30));	

	$form->addElement(FORM_GROUP_MAIN, new form_element_submit("submit", "Agregar M&oacute;dulo", '', '', 20));
	return $form->getForm();
    }
