<html>
<head>
<title>Sistema de Combustibles - Movimiento de Puntos de Fidelizacion</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=PROMOCIONES.RETENCIONES&task=RETENCIONES" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
