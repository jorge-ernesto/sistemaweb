...
SELECT
 ...
 FC.ch_fac_seriedocumento||'-'||FC.ch_fac_numerodocumento AS NumAtCard,
 FC.ch_fac_seriedocumento AS FolioPrefixString,
 FC.ch_fac_numerodocumento AS FolioNumber,
 FIRST(ERPMP.sap_codigo) AS PaymentGroupCode,
...
SELECT
 ...
 (CASE WHEN FIRST(PT.codigo) != '11620307' THEN '03' ELSE '02' END) AS CostingCode3,
