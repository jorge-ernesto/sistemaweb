...
switch($accion){
	...
	case "Reporte":	
		...
		$rs_vales_mes_pasado			=  REPORTE_CUADRE_FACTURACION_1($c_fec_desde,$c_fec_hasta,"VALES_PASADO");
...
<form name="form1" action="generar_reporte_cuadre_facturacion.php" target="_blank" method="post">
<table width="774" border="0" cellpadding="1" cellspacing="1">
    	<tr> 
      		<td width="22%" height="24">&nbsp;</td>
      		<td colspan="3"><div align="center">CUADRE DE FACTURACION</div></td>
      		<td width="17%">&nbsp;
      		</td>
    	</tr>
   	<tr> 
