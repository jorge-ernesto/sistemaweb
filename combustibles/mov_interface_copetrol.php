...
<html>
	<head>
		...
		<title>Interface CopetrolDO</title>
		...
		window.onload = function() {
			$(function() {
				...
				$( "[id='datos[fechaini]']" ).datepicker({
					changeMonth: true,
					changeYear: true,
				})

				$( "[id='datos[fechafin]']" ).datepicker({
					changeMonth: true,
					changeYear: true,
				})
			});
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.INTERFAZCOPETROL&task=INTERFAZCOPETROL" frameborder="1" width="5" height="5"></iframe>
</body>
</html>
