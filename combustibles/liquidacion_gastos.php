<html>
<head>
<title>Sistema de Ventas - Liquidaci&oacute;n de Gastos</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.LIQUIDACIONGASTOS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
