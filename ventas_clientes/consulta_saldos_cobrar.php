<html>
<head>
<title>Sistema de Ventas - Consultas de Saldos</title>
...
<script language="JavaScript" src="js/consulta_saldos.js"></script>
</head>
<body>
...
<script src="/sistemaweb/js/jquery.scrollTo.js" type="text/javascript"></script>
    <div id="content_title">&nbsp;</div>
    <div id="content_body">&nbsp;</div>
    <div id="content_footer">&nbsp;</div>
</div>
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.CONSULTA" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
