...
class AgentePercepcionTemplate extends Template {
 
  function titulo(){
    $titulo = '<div align="center"><h2>Agentes de Percepci&oacute;n</h2></div><hr>';
    return $titulo;
  }
  ...
  function listado($registros){
    ...
    $titulo_grid = "AGENTES DE PERCEPCI&Oacute;N";
  ...
  function formBuscar($paginacion){
   //echo "ENTRO BUSCAR\n";
    ...
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_PERCEPCION'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_PERCEPCION'));
  ...
  function formAgentePercepcion($datos)
  {
    
    $form = new form2('AGENTE DE PERCEPCI&Oacute;N', 'form_agen_ret', FORM_METHOD_POST, 'control.php', 'multipart/form-data', 'control');
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_PERCEPCION'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_PERCEPCION'));
