...
class ProductosModel extends Model {
	...
	function agregar($codigo_combu,$nombre_combu,$nu_precio_combu,$codigopec,$codigo_combex,$nombre_breve) {
		...
		$validar = ProductosModel::ValidaTipoCambio($codigo, $nombre_combu);
	...
	function recuperarRegistroArray($codigo,$nombre_combu){
	  	global $sqlca;
		    ...
		    $query = "select 
				...
				from
					comb_ta_combustibles
				where
					ch_codigocombustible = '$codigo' AND
					ch_nombrecombustible  = '$nombre_combu';";
	...
	function ValidaTipoCambio($codigo,$nombre_combu){
		global $sqlca;
