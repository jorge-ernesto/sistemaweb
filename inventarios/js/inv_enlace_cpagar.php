...
<div align="center">
	<h3 style="color: #336699; text-align: center;">Registro de Compras</h3>
	<form name="form1" method="post" style="background-color:white">
		<input type="hidden" name="insnc" value="<?php echo $ncredito=$_REQUEST['nc'];?>"/>
		<?php
//			echo "Almacen ".$almacen_interno_ing_inv;
		?> 
		<input name="almacen_interno_ing_inv" type="hidden" id="almacen_interno_ing_inv" value="<?php echo $almacen_interno_ing_inv;?>">
		<br>
		<!--<input type="button" onClick="javascript:alert(docs_sunat[cod_documento.value]);">-->
...
?>
	...
	<?php
		//echo "Fecha Emision: ".$femision;//COMENTADO EL DÍA 26/07/2016
	?> 
	...
	<table bgcolor="#FFFFFF" border="1">
		<tr>
			<td align="right">Fecha Periodo: </td>
			<td><input name="fecha_reg" type="text" id="fecha_reg" class="fecha_formato" maxlength="10" size="10" value="<?php echo $fecha_reg;?>"></td>
      		</tr>
		<tr> 
        		<td align="right">Fecha Emision:</td>
		        <td><div align="left"> <?php //antes $fecha_doc ?>
				<input name="fecha_doc" type="text" id="fecha_doc" class="fecha_formato" maxlength="10" size="10" value="<?php echo $femision;?>"></div>
			</td>
			<td align="right">Fecha Vencimiento: </td>
			<td><input name="fecha_ven" type="text" id="fecha_ven" maxlength="10" size="10" value="<?php echo $femision;?>"></td>
      		</tr>
      		<tr>
	        	<td align="right">Proveedor: </td>
        		<td colspan="3">
				<input readonly="true" name="des_proveedor" type="text" size="60" value="<?php echo $cod_proveedor.' - '.$des_proveedor;?>" onFocus="javascript:chiches(iframe1,'Fecha_Documento',fecha_doc.value,'fecha_doc','fecha_doc');"> 
		  		...
		  		<?php
					if($des_proveedor_campo==""){
						$des_proveedor_campo = $des_proveedor;
					}
				?>
		  		<input type="hidden" name="des_proveedor_campo" value="<?php echo $des_proveedor_campo;?>">
			</td>
		</tr>
      		<tr> 
		...
		<tr> 
			...
			<td> Numero: 
				<input readonly="true" name="num_documento" type="text" id="num_documento" value="<?php echo $num_documento;?>"> 
		...
		<tr> 
			...
			<td>
				<select name="des_moneda" onChange="cod_moneda.value = this.value , pasarTexto(this,descrip_moneda) , recalcularMontos(form1),enviarDatos(form1,'cambiarTipoCambio');">
		...
		<tr>
			<td>Importe Total: </td>
        		<td>
				<input name="imp_total" type="text" id="imp_total" value="<?php echo $imp_total;?>" onKeyUp="javascript:calcularMontos2(form1,'total')">
			</td>
        		<td>Percepcion: </td>
		...
		<tr>
        		<td colspan="6">
				<input name="art_costo_uni" type="hidden"> <input name="art_stock" type="hidden" id="art_stock"  value="" size="10">
				<div align="center"><br>
