				...
				<div class="column">
		        	...
		        	<div class="form-check">
						<label class="form-check-label">
							<input type="checkbox" class="form-check-input" id="chk-generar-asientos-reversion" name="generar-asientos-reversion"> ¿Esta seguro de generar Asientos de Reversion?
    					</label>
						
						<br>

						<label class="form-check-label">
							<input type="checkbox" class="form-check-input" id="chk-cerrar-periodo" name="cerrar-periodo"> <span id="chk-txt-periodo">¿Desea cerrar el periodo <?php echo "(".date("Y").")"; ?> indicado?</span> 
						</label>
					</div>
		        	...
		        	<div class="form-check">
						<label class="form-check-label">
							<input type="checkbox" class="form-check-input" id="chk-eliminar-asientos-reversion" name="eliminar-asientos-reversion"> ¿Esta seguro de eliminar Asientos de Reversion?
    					</label>
					</div>
		        	...
		        	<div class="form-check">
						<label class="form-check-label">
							<input type="checkbox" class="form-check-input" id="chk-regenerar-balance" name="regenerar-balance"> Soy conciente de que este proceso regenera el balance de todos los meses del año en base a los asientos actuales
    					</label>
					</div>
		       	</div>			
		    </div>
