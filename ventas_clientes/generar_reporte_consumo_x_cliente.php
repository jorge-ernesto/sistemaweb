...
?><html>
<head>
<title>Sistema de Ventas - Consumo por Cliente</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.CONSUMO&task=CONSUMO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>