...
where tab_tabla='ALMA' and tab_elemento!='000000' and tab_car_02='1' and (tab_elemento like '%".$updalmaco1."%' or tab_descripcion like '%".$updalmaco1."%') order by tab_descripcion";
