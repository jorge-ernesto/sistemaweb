...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.INTERFAZDOMINIO&task=INTERFAZDOMINIO" frameborder="1" width="5" height="5"></iframe>
</body>
</html>