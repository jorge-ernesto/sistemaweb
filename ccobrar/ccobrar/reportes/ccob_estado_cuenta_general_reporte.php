...
class ReporteGeneralTemplatePDF {
		...
		$CabCli = array( 	"NOMCLI"          =>  " "  );
    		...
    		$reporte->definirColumna("CLIENTE", $reporte->TIPO_TEXTO, 11, "L");
    		$reporte->definirColumna("DOCUMENTO", $reporte->TIPO_TEXTO, 20, "L");
    		$reporte->definirColumna("F. EMISION", $reporte->TIPO_TEXTO, 10, "R");
    		$reporte->definirColumna("F. VENCI.", $reporte->TIPO_TEXTO, 10, "R");
    		$reporte->definirColumna("MONEDA", $reporte->TIPO_TEXTO, 6, "L");
    		$reporte->definirColumna("IMPORTE", $reporte->TIPO_IMPORTE, 10, "R");    		
    		$reporte->definirColumna("SUCURSAL", $reporte->TIPO_TEXTO, 15, "C");
    		$reporte->definirColumna("DOLARES", $reporte->TIPO_IMPORTE, 10, "R");
    		$reporte->definirColumna("SOLES", $reporte->TIPO_IMPORTE, 10, "R");
