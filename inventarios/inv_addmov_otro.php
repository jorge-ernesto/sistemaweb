...
inv_tipotransa basado en la variable fm que le llega, compara fm con tran_codigo en esa tabla*/
...
<form action="" method="post" name="form1" id="form1">
  <table width="734" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td><input type="text" name="alma_des" size="6" value="<?php echo trim($alma_des);?>" 
	<?php echo $read_des;?> >
...
<input type="hidden" name="entidad_validacion" value="<?php echo $enti;?>">
      ...
      <td><div align="center"> 
        ...
        <?php if(trim($fm)=="21"){?>
          <img src="../images/help.gif" width="16" height="15" onMouseOver="this.style.cursor='hand'" onclick="javascript:mostrarAyudaGLP('js/calculo_ayuda_glp.php','<?php echo $nro_mov; ?>','<?php echo $fm; ?>',document.form1.cod_articulo.value,'<?php echo $fecha_actual;?>','art_cantidad');"> 
        <?php } ?>
        </div></td>
      <td><div align="center"> 
	...
	<?php } else { ?>
      		<td colspan="3"> <input name="btn_ingresar" type="button" value="Ingresar" onClick="javascript:mandarDatos2(form1,'Ingresar');">
	<?php } ?>
      </td>
    </tr>
    <tr> 
