<html>
<head>
<title>Sistema de Inventarios - Productos por Proveedor</title>
...
<script language="JavaScript" src="/sistemaweb/maestros/js/productoxproveedor.js" type="text/javascript" ></script>
</head>
<body>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.PRODXPROV" frameborder="1" width="10" height="10"></iframe>
</body>
</html>