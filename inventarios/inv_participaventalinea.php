...
<html>
	<head>
		...
		<title>Sistema de Inventarios - Participacion de Venta por Linea</title>
		<link rel="stylesheet" href="/sistemaweb/css/sistemaweb.css" type="text/css">
		<script language="JavaScript" src="js/kardex.js"></script>
		<script language="JavaScript" src="js/participaventalinea.js"></script>
	...
	<body>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.PARTICIPAVENTALINEA" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
