<html>
<head>
<title>Sistema de Combustibles - Puntos por Producto</title>
  <link rel="stylesheet" href="/sistemaweb/css/sistemaweb.css" type="text/css">
  <script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/images/stm31.js"></script>
  <script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/combustibles/js/sispuntosxproducto.js"></script>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=PROMOCIONES.PUNTOSXPRODUCTO&task=PUNTOSXPRODUCTO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>