<!DOCTYPE html>
	<meta charset="UTF-8">
    <head>
		<title>Ventas Centralizadas Dev</title>
	...
	<body>
		...
		echo TemplateRegistroVentasCental::renderFromVentasCentralizadas(array(
			'status_connection_server_central' => $status_connection_server_central,
