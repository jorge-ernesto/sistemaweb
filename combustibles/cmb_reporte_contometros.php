...
<html>
	<head>
		...
		<title>Sistema de Combustibles - Reporte de Contometros por Lado</title>
		...
		<script language="JavaScript" src="js/contometros.js"></script>
	...
	<body>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.CONTOMETROS&task=CONTOMETROS" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
