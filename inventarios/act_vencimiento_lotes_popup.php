<html>
<head>
<title>Sistema de Ventas - Actualizacion - Control de Vencimiento de Lotes</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.VENCIMIENTOLOTES&action=Modificar&formulario=<?php $_REQUEST['formulario']; ?>&articulo=<?php $_REQUEST['articulo']; ?>&lote=<?php $_REQUEST['lote']; ?>" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
