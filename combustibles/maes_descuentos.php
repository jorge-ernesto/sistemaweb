<html>
<head>
<title>Sistema de Combustibles - Descuentos especiales</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.DESCUENTOS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>