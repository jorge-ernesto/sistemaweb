...
if($cod_almacen!=""){
//$rs6 = pg_exec("select tab_elemento as cod,tab_descripcion from int_tabla_general where tab_tabla='ALMA' and tab_car_02='1' and  trim(tab_elemento)=trim('$cod_almacen') order by cod"); 
$rs6 = pg_exec("select trim(ch_almacen) as cod,ch_nombre_almacen from inv_ta_almacenes where ch_clase_almacen='1' and trim(ch_almacen)=trim('$cod_almacen') order by cod"); 
