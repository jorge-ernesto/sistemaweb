...
function mostrarProcesarCos(url,cod,des,cost,consulta,prove,moneda,tcambio){
url = url+"?cod="+cod+"&des="+des+"&cost="+cost+"&consulta="+consulta+"&prove="+prove+"&moneda="+moneda+"&tcambio="+tcambio;
window.open(url,'miwin','width=500,height=350,scrollbars=yes,menubar=no,left=390,top=20');
}

function mostrarAyudaCos(url,cod,des,cost,consulta,prove,moneda,tcambio){
url = url+"?cod="+cod+"&des="+des+"&cost="+cost+"&consulta="+consulta+"&prove="+prove+"&moneda="+moneda+"&tcambio="+tcambio;
window.open(url,'miwin','width=500,height=350,scrollbars=yes,menubar=no,left=390,top=20');
}
