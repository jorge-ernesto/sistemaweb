...
<html>
	<head>
		...
		<title>Sistema de Inventarios - Consistencia de Almacen</title>
		<link rel="stylesheet" href="/acosa/acosa.css" type="text/css">
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.CONSISTENCIA" frameborder="1" width="10" height="10"></iframe>
</body>
</html>