function cargarLista(tipo) {
	control.location.href='control.php?rqst=REPORTES.GENERAL&cod=0x&action=' + tipo;
}

function cargarListaBusqueda(tipo) {
	control.location.href='control.php?rqst=REPORTES.GENERAL&cod='+ window.document.getElementById("cod_busca").value + '&action=' + tipo;
}

function cargarListaOrdenarCodigo(tipo) {
	control.location.href='control.php?rqst=REPORTES.GENERAL&cod=Codigo&action=' + tipo;
}

function cargarListaOrdenarDescripcion(tipo) {
	control.location.href='control.php?rqst=REPORTES.GENERAL&cod=Descripcion&action=' + tipo;
}
...
function cargarListaGato() {
	control.location.href='control.php?rqst=REPORTES.ESPECIALES&action=TipoArticulo';
}
