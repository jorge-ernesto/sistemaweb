...
<title>Sistema de Ventas - Maestro de clientes</title>
  ...
  <script language="JavaScript" src="js/siscontrolvales.js"></script>
</head>
...
<div id="content">
    ...
    <div id="resultados_grid" align="center">&nbsp;</div>
    <div id="content_footer">&nbsp;</div>
</div>
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=FACTURACION.VALES&task=LISTADO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>