<?php
			...
			$v_sql_alma="select trim(ch_almacen) as cod, ch_nombre_almacen from inv_ta_almacenes  where ch_almacen like '%".$v_almacen."%' and  ch_clase_almacen='1' order by ch_almacen";
			...
			$v_sqlareq_det="select * from COM_TA_AREQ_DETALLE
