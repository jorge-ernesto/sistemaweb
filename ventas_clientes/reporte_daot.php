<html>
	<head>
	<title>Sistema de Ventas - Reportes DAOT</title>
	...
	<div id="footer">&nbsp;</div>
	<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.DAOT" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
