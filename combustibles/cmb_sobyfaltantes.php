	...
	?>
		...
		<table align="center" border="0">
			...
			for ($i = 0; $i < count($REP); $i++) {
				...
				echo "<td style=\"background-color: $color; color: #000000\"><div align=\"center\"><font size=\"-4\" face=\"Arial, Helvetica, sans-serif\">" . round(floatval($REP[$i][7]),2) . "</td>\n";
			...
			<tr>
				...
				<td align="center" style="font-size:0.7em; color:white; background-color: #30767F"><b><?php echo round(floatval($TOT_PARTE),2); ?></b></td>
