...
<body class="bulma">
    <section class="section">
		...
		include('reportes/t_asiento_inicial.php');
		include('reportes/m_asiento_inicial.php');

		$objAsientoInicialModel    = new AsientoInicialModel();
		$objAsientoInicialTemplate = new AsientoInicialTemplate();

		//Values for Template
		echo $objAsientoInicialTemplate->Inicio(
			$objAsientoInicialModel->ObtenerEstaciones(),
...
<script charset="utf-8" type="text/javascript" src="/sistemaweb/contabilidad/js/asiento_inicial.js?ver=2.7"></script>
