...
Class DaotModel extends Model{
	...
	function generarDaot($anio, $base, $ruc){
		...
		$sql="CREATE TEMPORARY TABLE tmpDaot (ruc text, razsocial text, cliente text, caja character varying(4), trans character varying(10), dia timestamp without time zone, turno character varying(1), vventa numeric, igv numeric, total numeric );";
		$sqlca->query($sql);
		...
		$sql="INSERT INTO tmpdaot 
			SELECT 
				...
				com.ch_fac_nombreclie as cliente,
