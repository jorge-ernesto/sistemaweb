...
include("cpag_inclu_fac_support.php");
...
switch($accion){
	...
	location.href = 'cpag_inclu_fac.php?accion=Cancelar';
	</script>
	<?php
    break;
 ...
 <div class="form" align="center">
  ...
  <td colspan="1" class="form_group">
	...
	<tr>
	    ...
	    <td> : <?php if($fec_docu==""){$fec_docu = date("d/m/Y");} ?>
	    <input size="12" class="form_input" type="text" name="fec_docu" value="<?php echo $fec_docu;?>" onBlur="javascript:chiche(iframe1,'Fecha_Documento',fec_docu.value,'fec_docu','fec_docu');">
	    </td>
		...
		<tr>
		    ...
		    <input type="hidden" name="fec_reg" value="<?php echo date('d/m/Y');?>">
		    <input type="hidden" name="num_registro" value="<?php echo $num_registro;?>" maxlength="10">
		    </td>
		    <td class="form_label">: <?php echo date('d/m/Y');?></td>
		<tr>
		</table>
	    </td>
	</tr>
	...
	<tr>
	    ...
	    <td class="form_label">:<input size="12" class="form_input" type="text" name="cod_docref"  value="<?php echo $cod_docref;?>" onFocus="javascript:verificarIntegridad(iframe1,cod_proveedor,cod_documento,serie_doc,num_documento);" onBlur="javascript:cceros(num_documento,7,'num_documento','Debes numero de Documento');">
	    </td>
	    <td>
	...
	<tr>
	    ...
	    <td><input class="form_input" type="text" name="monto_compras" size="8" readonly="yes" onFocus="javascript:btn_devoluciones.focus();"></td>
	    <td></td>
	    <td>
	       <table>
	        <tr>
	         ...
	         <td><input class="form_input" type="text" name="monto_devoluciones" size="8" readonly="yes" onFocus="javascript:many_alma.focus();"></td>
	        </tr>
	       </table>
	    </td>
	    <td>
	...
	<tr>
	   ...
	   <table border="0" cellpadding="3" cellspacing="3">
		...
		<table border="0" cellpadding="3" cellspacing="3">
		<tr>
		<td><input class="form_button" type="button" name="Ingresar" value="Ingresar" onClick="javascript:mandarDatos(form1,'Ingresar');"></td>
		<td><input class="form_button" type="button" name="Cancelar" value="Cancelar" onClick="monto_imp.value='',importe_total.value='',mandarDatos(form1,'Cancelar')"></td>
		</tr>
		</table>
	    </fieldset>
	    </td>
...
<script>chiche(iframe1,'Fecha_Documento',form1.fec_docu.value,'fec_docu','fec_docu');</script>
</body>
</html>
<?php pg_close();?>
