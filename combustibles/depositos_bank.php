<html>
 <head>
  <title>Sistema de Ventas - Combliquidacion ventas GNV</title>
   ...
   <script language="JavaScript" src="js/depositos_bank.js"></script>
 </head>
...
<div id="content">
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.DEPOSITOSBANK" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
