<html>
<head>
<title>Sistema de Promociones - Tipos de Cuenta</title>
  <link rel="stylesheet" href="/sistemaweb/css/sistemaweb.css" type="text/css">
  <script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/images/stm31.js"></script>
  <script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/combustibles/js/sistipocuenta.js"></script>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=PROMOCIONES.TIPOSCUENTA&task=TIPOSCUENTA" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
