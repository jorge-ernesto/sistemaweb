<html>
 <head>
  <title>Sistema de Ventas - Serie de Documento</title>
...
<div id="content">
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.SERIEDOCUMENTO" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
