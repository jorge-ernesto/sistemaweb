...
<script> 
function escojtipo(k_par){ 
    eval("opener.document."+k_par+".value = document.formular2.escogtipo.value")
...
<?php
 ...
 $tipo1=strtoupper($tipo1);
  $sqlai="select tab_elemento,tab_descripcion from int_tabla_general where tab_tabla='21' and tab_elemento!='000000' and (tab_elemento like '%".$tipo1."%' or tab_descripcion like '%".$tipo1."%') ";
...
<input type="Button" name="boton" value="Seleccionar" onclick="escojtipo('<?php echo $k_variable; ?>')">
<?php
  }
//}
?>
