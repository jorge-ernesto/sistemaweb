...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.SUNAT_PERCEPCION&task=SUNAT_PERCEPCION" frameborder="1" width="5" height="5"></iframe>
</body>
</html>