...
<html>
	<head>
		...
		<title>Sistema de Combustibles - Parte de Liquidacion de Ventas de Market</title>
	...
	<body>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.PARTEMARKET&task=PARTEMARKET" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
