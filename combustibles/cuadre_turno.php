...
<html>
	<head>
		...
		<title>Sistema de Ventas - Cuadre de Turno por Ticket</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.CUADRETURNO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
