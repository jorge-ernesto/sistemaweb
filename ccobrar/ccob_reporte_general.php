...
<html>
	<head>
		...
		<title>Sistema de Estado de Cuenta General</title>
	...
	<body>
		...
		<div id="footer">&nbsp;</div>
		<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.GENERALES" frameborder="1" width="10" height="10"></iframe>
	</body>
</html>
