<html>
 <head>
  <title>Sistema Configuracion de Productos - Configuracion de Productos</title>
 ...
 <body>
  ...
  <?php include "../menu_princ.php"; ?>
   ...
   <div id="footer">&nbsp;</div>
    <iframe id="control" name="control" scrolling="no" src="control.php?rqst=MAESTROS.PRODUCTOS&task=PRODUCTOS" frameborder="1" width="10" height="10"></iframe>
 </body>
</html>
