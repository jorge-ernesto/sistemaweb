...
//consulta para capturar nombre completo de trabajador
			...
			$sql2="select ch_nombre1, ch_apellido_paterno from pla_ta_trabajadores where trim(ch_codigo_trabajador)=trim(".$documento.") and (ch_puesto like '0039  ' or ch_puesto like '0501  ' or ch_puesto like '0509  ' or ch_puesto like '0511  ')";


//			$sql2="select ch_nombre1, ch_apellido_paterno from pla_ta_trabajadores where trim(ch_codigo_trabajador)=trim(".$documento.")";

//and ch_puesto like '0039  .0501  .0509  .0511  ';
