...
class AgentePercepcionViTemplate extends Template {
 
  function titulo(){
    $titulo = '<div align="center"><h2>Agentes de Percepci&oacute;n Venta Interna</h2></div><hr>';
    return $titulo;
  }
  ...
  function listado($registros){
    ...
    $titulo_grid = "AGENTES DE PERCEPCI&Oacute;N VENTA INTERNA";
  ...
  function formBuscar($paginacion){
   //echo "ENTRO BUSCAR\n";
    ...
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_PERCEPCION_VI'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_PERCEPCION_VI'));
  ...
  function formAgentePercepcionVi($datos)
  {
    
    $form = new form2('AGENTE DE PERCEPCI&Oacute;N VENTA INTERNA', 'form_agen_ret', FORM_METHOD_POST, 'control.php', 'multipart/form-data', 'control');
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('rqst', 'MAESTROS.SUNAT_PERCEPCION_VI'));
    $form->addElement(FORM_GROUP_HIDDEN, new f2element_hidden('task', 'SUNAT_PERCEPCION_VI'));
