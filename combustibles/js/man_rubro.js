function PaginarRegistros(rxp, valor) {   	
	urlPagina = 'control.php?rqst=REPORTES.MAN_CASHOPE&rxp='+rxp+'&pagina='+valor;
	document.getElementById('control').src = urlPagina;	
}

function PaginarRegistrosFecha(rxp, valor, fecha, fecha2) {   	
	urlPagina = 'control.php?rqst=REPORTES.MAN_CASHOPE&action=Buscar&rxp='+rxp+'&pagina='+valor+'&fecha='+fecha+'&fecha2='+fecha2;
	document.getElementById('control').src = urlPagina;	
}
...
function regresar() {
	url = 'control.php?rqst=REPORTES.MAN_CASHOPE';
