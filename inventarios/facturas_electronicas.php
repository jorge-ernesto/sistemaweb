<html>
<head>
<title>Sistema de Combustibles - Facturas Electronicas</title>
...
<script language="JavaScript" src="js/fac_electronicas.js"></script>
</head>
<body>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.FACTURASELECTRONICAS" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
