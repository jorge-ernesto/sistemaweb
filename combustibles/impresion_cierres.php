<html>
<head>
<title>Sistema de Combustibles - Impresion de Cierres</title>
...
<script language="JavaScript" src="js/afericiones.js"></script>
</head>
<body>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.IMPRESIONCIERRES" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
