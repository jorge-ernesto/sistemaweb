...
*/
		...
		case Agregar:
			$sql = "insert into pos_fptshe1 
				(codcli, codcue, numtar, nomusu
				, numpla, ventar, estblo, segres, feccre
				
				,dt_fecha_upd, ch_ip_upd, ch_usuario_upd) values

				('$new_codigo','$new_cta_pec','$new_shell','$new_usuario'
				,'$new_placa','$new_vencimiento','$new_bloqueada','$new_segres' ,now()
				, now(), '$ip_remoto', '$usuario')";
...
$sql = "select codcli, codcue ,numtar, nomusu, numpla, ventar, estblo
				, cli_grupo, to_char(feccre, 'DD/MM/YYYY'), estarj, segres, 

				ch_tipo_producto, nu_limite_galones, nu_limite_importe,
				ch_tipo_periodo_acumular, ch_dia_de_corte,
				
				nu_galones_acumulados, nu_ant_galones_acumulados,
				
				nu_importe_acumulado, nu_ant_importe_acumulado
				
		from pos_fptshe1 she, int_clientes clie
		where trim(codcli)=trim(cli_codigo)
		and numtar='$m_clave'";
...
<body>
Tarjeta de Credito Shell
<form name="formular" method="post" action="">
  <table width="769" border="0">
    <tr> 
      <td width="400" bgcolor="#006666" class="borde-cuadro"><font color="#FFFFFF">DATOS 
        DE TARJETA</font></td>
      <td width="4"><font color="#FFFFFF">&nbsp;</font></td>
      <td width="400" bgcolor="#006666" class="borde-cuadro"><font color="#FFFFFF">RESTRICCIONES 
        DE DESPACHO</font></td>
    </tr>
    <tr> 
      <td><table width="400" border="0" class="borde-cuadro">
          <tr> 
            <td width="157">Cod. Cliente</td>
            <td width="8">:</td>
            <td><input name="new_codigo" type="text" id="new_codigo" value="<?php echo $new_codigo; ?>" size="8" maxlength="6" <?php echo $v_estado; ?> ></td>
          </tr>
          <tr> 
            <td>Nro. Cuenta</td>
            <td>:</td>
            <td><input name="new_cta_pec" type="text" id="new_cta_pec" value="<?php echo $new_cta_pec; ?>" size="13" maxlength="10" <?php echo $v_estado; ?> ></td>
          </tr>
          <tr> 
            <td>Nro. Tarjeta Shell</td>
            <td>:</td>
            <td><input name="new_shell" type="text" id="new_shell" value="<?php echo $new_shell; ?>" size="13" maxlength="10" <?php echo $v_estado; ?> ></td>
          </tr>
          <tr> 
            <td>Usuario</td>
            <td>:</td>
            <td><input name="new_usuario" type="text" id="new_usuario" value="<?php echo $new_usuario; ?>" size="40" maxlength="40"></td>
          </tr>
          <tr> 
            <td>Placa Vehiculo</td>
            <td>:</td>
            <td><input name="new_placa" type="text" id="new_placa" value="<?php echo $new_placa; ?>" size="10" maxlength="8"></td>
          </tr>
          <tr> 
            <td>Vencimiento</td>
            <td>:</td>
            <td width="219"><input name="new_vencimiento" type="text" id="new_vencimiento" value="<?php echo $new_vencimiento; ?>" size="13" maxlength="10"></td>
          </tr>
          <tr> 
            <td>T. Bloqueada S/N</td>
            <td>:</td>
            <td><input name="new_bloqueada" type="text" id="new_bloqueada" value="<?php echo $new_bloqueada; ?>" size="2" maxlength="1"></td>
          </tr>
          <tr> 
            <td colspan="3"><hr></td>
          </tr>
          ...
          <tr> 
            ...
            <td>:</td>
            <td><input name="new_segres" type="text" id="new_segres" value="<?php echo $new_segres; ?>" size="2" maxlength="1"></td>
          </tr>
          <tr> 
            <td><div align="center"> 
            ...
            <td><div align="center"> 
                <input name="button" type="button" onClick="javascript:validarFormulario()" value="<?php echo $accion; ?>">
              </div></td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
      <td valign="top"> <table width="340" border="0" class="borde-cuadro">
          <tr> 
            <td width="193" height="27">Solo para</td>
            <td width="7">:</td>
            <td width="123"><select name="new_tipo">
          ...
          <tr> 
            ...
            <td>:</td>
            <td><select name="new_control" onChange="cambiarDias()" >
          ...
          <tr> 
            ...
            <td>:</td>
            <td><select name="new_nro_dia" size="1" id="new_nro_dia">
