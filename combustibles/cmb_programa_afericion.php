<html>
<head>
<title>Sistema de Ventas - Programar Afericiones</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=MOVIMIENTOS.PROGRAMA_AFERICION" frameborder="1" width="10" height="10"></iframe>
</body>
</html>
