...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/sistemaweb/css/styles.css">
		<script language="JavaScript1.2" src="/sistemaweb/images/stm31.js"></script>
		<script type="text/javascript" language="JavaScript1.2" src="/sistemaweb/ccobrar/js/report_analitico.js"></script>
		...
		<script src="/sistemaweb/ccobrar/js/autocomplete.js" type="text/javascript"></script>
...
<body leftmargin="0" topmargin="0">
	...
	<div id="footer">&nbsp;</div>
	<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.ANALITICO&task=ANALITICO" frameborder="1" width="5" height="5"></iframe>
</body>
</html>
