...
?><html>
<head>
<title><?php echo $usuario->obtenerNombreSistemaActual(); ?> - Registro de Cuentas por Pagar</title>
...
<div id="footer">&nbsp;</div>
<iframe id="control" name="control" scrolling="no" src="control.php?rqst=REPORTES.REGISTRO" frameborder="1" width="10" height="10"></iframe>
</body>
</html>